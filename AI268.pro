...
CLAUSES
список_партнеров_по_росту(Список) :- Список = [партнер("Люся", "Егорова", ж), партнер("Оля", "Петрова", ж), партнер("Юра", "Воробьев", м),
партнер("Инна", "Крымова", ж), партнер("Андрей", "Егоров", м), партнер("Аня", "Воробьева", ж), партнер("Сережа", "Петров", м), партнер("Дима", "Крымов", м)].

возможный_партнер(Партнер, Пол) :- список_партнеров_по_росту(Список),
                                   входит_в(Партнер, Список),
                                   Партнер = партнер(_, _, Пол_партнера),
                                   not(Пол = Пол_партнера).

родственники(Партнер_1, Партнер_2) :- Партнер_1 = партнер("Люся", "Егорова", ж), Партнер_2 = партнер("Андрей", "Егоров", м);
                                      Партнер_1 = партнер("Оля", "Петрова", ж), Партнер_2 = партнер("Сережа", "Петров", м);
                                      Партнер_1 = партнер("Инна", "Крымова", ж), Партнер_2 = партнер("Дима", "Крымов", м);
                                      Партнер_1 = партнер("Аня", "Воробьева", ж), Партнер_2 = партнер("Юра", "Воробьев", м).
...
условие_по_росту(пара(Девушка, Парень)) :- список_партнеров_по_росту(Список),
...
проверка_условия_по_росту([Пара|Хвост_списка]) :- условие_по_росту(Пара),
                                                  проверка_условия_по_росту(Хвост_списка).

условие_отсутствия_пар_брат_и_сестра(пара(Девушка, Парень)) :- not(родственники(Девушка, Парень)).

проверка_отсутствия_пар_брат_и_сестра([]).
проверка_отсутствия_пар_брат_и_сестра([Пара|Хвост_списка]) :- условие_отсутствия_пар_брат_и_сестра(Пара),
...
генерация_и_проверка_гипотезы(Список_пар) :-
        ...
        Список_пар = [пара(партнер("Люся", "Егорова", ж), Партнер_1), пара(партнер("Оля", "Петрова", ж), Партнер_2),
                      пара(партнер("Инна", "Крымова", ж), Партнер_3), пара(партнер("Аня", "Воробьева", ж), Партнер_4)],
...
поиск_решения(Список_пар) :- write("Возможные варианты:"),nl,
