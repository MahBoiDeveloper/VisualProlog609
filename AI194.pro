...
CLAUSES
    ...
    входит_в(Персонаж,[ _ | Хвост_Списка_Персонажей ])
    :-
        входит_в(Персонаж, Хвост_Списка_Персонажей)
    .
    ...
    :- 
        входит_в(Имя, ГоловаВиновных),
        not(ХвостВиновных = []),
        проверка(Имя, ХвостВиновных)
    ;
        ХвостВиновных = [],
        входит_в(Имя, ГоловаВиновных)
    .
...
%% Генерация гипотезы    
    ...
    :-
        ...
        (
            Имя, 
            входит_в(персонаж(Имя, виновен), Подозреваемые), 
            Виновные
        ), 
...
%1.Если А виновен и В невиновен, то С виновен; 
    ...
    :-
        входит_в(персонаж("A", виновен),    Подозреваемые),
        входит_в(персонаж("B", не_виновен), Подозреваемые),  
        входит_в(персонаж("C", виновен),    Подозреваемые)
    ;
        входит_в(персонаж("A", не_виновен), Подозреваемые)
    ;
        входит_в(персонаж("B", виновен),    Подозреваемые)
    .
...
%3.А никогда "не ходит на дело" вместе с С;          
    ...
    :-
        входит_в(персонаж("A",     виновен),    Подозреваемые),
        not(входит_в(персонаж("C", виновен),    Подозреваемые))
    ;
        входит_в(персонаж("A",     не_виновен), Подозреваемые)
    .
...
%% Проверка гипотезы       
    ...
    :-
        ...
        (
            ВариантыВиновных, 
            поиск_виновного_с_проверкой(ВариантыВиновных), ВсеВиновные),
