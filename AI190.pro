...
CLAUSES
    ...
    :-
        ...
        [
            участник(борис, _), 
            участник(алексей, присутствует), 
            участник(валерий, отсутствует)
        ],
        Участвующие = 
        [
            участник(борис, _),
        ...
        !,
        определение_количества_элементов(Хвост, N, Участвующие),
        K = N + 1
    ;
        Варианты_собрания = 
        [
            участник(борис, _),
            участник(алексей, отсутствует),
            участник(валерий, отсутствует)
        ],
        Участвующие = 
        [
    ...
    :- 
        Количество1 = 0,
        Ответ = "обязательно отсутствует"
    ;
        not(Количество2 = 0),
        Количество2 = Количество1, 
        Ответ = "обязательно присутствует"
    ;
        not(Количество2 = 0),
        Количество2 < Количество1, 
    ...
    входит_в(Участник,[ _ | Хвост_Списка_Участников ])
    :-
        входит_в(Участник, Хвост_Списка_Участников)
    .
...
%% Генерация гипотезы   
    ...
    :-      
        возможное_состояние(Присутствие1),
        возможное_состояние(Присутствие2),
        возможное_состояние(Присутствие3),
        Участники =
        [
            участник(борис,   Присутствие1),
            участник(алексей, Присутствие2),
            участник(валерий, Присутствие3)
        ]
    .
...
%% Проверка гипотезы   
    ...
    :-
        ...
        (
            Варианты_участников, 
            проверка_гипотезы(Варианты_участников),
            Участники
        ),
        определение_количества_элементов
        (
            Участники, 
            Количество1,
            [
