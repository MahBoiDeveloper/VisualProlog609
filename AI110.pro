...
%Определяем поиск подсудимого из списка
    ...
    найти([ _ | Хвост_списка ], Первый)
    :-
        найти(Хвост_списка, Первый)
    .
%Определяем поиск показания из списка по номеру
    найти_показание([ Первый | _ ], Номер, Первый)
    :-
        Номер - 1 = 0
    .
    найти_показание([ _ | Хвост_списка ], Номер, Первый)
    :- 
        Номер_1 = Номер - 1,
        найти_показание(Хвост_списка, Номер_1, Первый)
    .
%Определяем показания
    сказал(1, Сказал, Вина, Честность, Подсудимые)
    :-
        найти(Подсудимые, подсудимый(1, Сказал, Вина, Честность))
    .
    сказал(2, Сказал, Вина, Честность, Подсудимые)
    :-
        найти(Подсудимые, подсудимый(2, Сказал, Вина, Честность))
    .
    сказал(3, Сказал, Вина, Честность, Подсудимые)
    :-
        найти(Подсудимые, подсудимый(1, _, Вина, _)),
...
%Определяем проверку показаний
    проверка_показания(Подсудимые, Номер)
    :-
        сказал(Номер, Сказал, Вина, честный, Подсудимые),
        ответ(Сказал, Обвинение),
	    Вина = Обвинение
    .
    проверка_показания(Подсудимые, Номер)
    :-
        сказал(Номер, Сказал, Вина, лжец, Подсудимые),
        ответ(Сказал, Обвинение),
	    not(Вина = Обвинение)
    .
%Определяем счетчик виновных подсудимых
	количество_виновных([], 0).
	количество_виновных([ Первый | Хвост_списка ], Количество)
    :-
        количество_виновных(Хвост_списка, Количество_1),
...
%Определяем условие о количестве виновных
    ...
    :-
        количество_виновных(Подсудимые, Количество),
        Количество = 1
    .
%Определяем счетчик честных и лживых подсудимых
	количество_по_честности([], 0, _).
	количество_по_честности([ Первый | Хвост_списка ], Количество, Честность)
    :-
        количество_по_честности(Хвост_списка, Количество_1, Честность),
...
%Определяем условие о количестве честных и лжецов
    ...
    :-
        количество_по_честности(Подсудимые, Количество_1, честный),
...
%Определяем генерацию гипотезы и ее проверку
    генерация_гипотезы(Показания, Подсудимые):-
		...
		Подсудимые = 
        [
            подсудимый(1, Сказал_1, Вина_1, Честность_1),
