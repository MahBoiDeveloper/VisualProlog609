...
PREDICATES
    ...
    nondeterm найти_все               (специалист, список_специалистов)
...
% проверка вхождения
    ...
    входит_в(Имя, [ _ | Хвост ])
    :-
        входит_в(Имя, Хвост)
    .
% поиск в списке
    найти_все(Первый, [ Первый | _ ]).
    найти_все(Первый, [ _ | Хвост ])
    :-
        найти_все(Первый, Хвост)
    .
% ...По особенностям психологической совместимости врачи рекомендуют совместные полеты Фриша и Кларка...
    рекомендация(1, Состав_экспедиции)
    :-
        входит_в("Фриш",  Состав_экспедиции), 
        входит_в("Кларк", Состав_экспедиции)
    ;
        not(входит_в("Фриш",  Состав_экспедиции)), 
        not(входит_в("Кларк", Состав_экспедиции))
    .
% ...а также Леонова с Хорхесом и Депардье...   
    рекомендация(2, Состав_экспедиции)
    :-
        входит_в("Леонов",   Состав_экспедиции), 
        входит_в("Хорхес",   Состав_экспедиции), 
        входит_в("Депардье", Состав_экспедиции)
    ;
        not(входит_в("Леонов",   Состав_экспедиции)), 
        not(входит_в("Хорхес",   Состав_экспедиции)), 
...
%    нам не подходит только случай, когда они оба вместе, а остальные случаи нам подходят
    ...
    :-
        not(входит_в("Депардье", Состав_экспедиции)),
        входит_в("Нам",          Состав_экспедиции)
    ;
        входит_в("Депардье", Состав_экспедиции),
        not(входит_в("Нам",  Состав_экспедиции))
    ;
        not(входит_в("Депардье", Состав_экспедиции)),
        not(входит_в("Нам",      Состав_экспедиции))
    .
...
%   аналогично рекомендации 3
    ...
    :- 
        not(входит_в("Волков", Состав_экспедиции)), 
        входит_в("Кларк",      Состав_экспедиции)
    ;
        входит_в("Волков",    Состав_экспедиции), 
        not(входит_в("Кларк", Состав_экспедиции))
    ;
        not(входит_в("Волков", Состав_экспедиции)),
        not(входит_в("Кларк",  Состав_экспедиции))
...
% генерируем и проверяем гипотезу
    ...
    :-
        % генерация гипотезы
        возможная_специальность(Аэронавт,       "Аэронавт"),
        возможная_специальность(Космонавигатор, "Космонавигатор"),
        возможная_специальность(Биомеханик,     "Биомеханик"),
        возможная_специальность(Энергетик,      "Энергетик"),
        возможная_специальность(Врач,           "Врач"),
        возможная_специальность(Астрофизик,     "Астрофизик"),

        Состав_экспедиции =
        [
            специалист(Аэронавт,       "Аэронавт"),
            специалист(Космонавигатор, "Космонавигатор"),
            специалист(Биомеханик,     "Биомеханик"),
            специалист(Энергетик,      "Энергетик"),
            специалист(Врач,           "Врач"),
            специалист(Астрофизик,     "Астрофизик")
        ],
        % проверка гипотезы
        проверка_рекомендаций(Состав_экспедиции),
        найти_все(специалист(Имя, Специальность), Состав_экспедиции)
    .
GOAL
    поиск_решения(Имя, Специальность).
