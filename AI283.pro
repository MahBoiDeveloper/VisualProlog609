...
%поиск по списку
    ...
    .
% 1. Приз находится в синем или зелёном ящике.
    подсказка(1, Список_ящиков)
    :-
        входит_в(ящик(синий,   есть), Список_ящиков)
    ;
        входит_в(ящик(зелёный, есть), Список_ящиков)
    .
% 2. Приз находится в красном или желтом ящике.
    подсказка(2, Список_ящиков)
    :-
        входит_в(ящик(красный, есть), Список_ящиков)
    ;
        входит_в(ящик(желтый,  есть), Список_ящиков)
    .
% 3. Приз находится в зелёном ящике.
    подсказка(3, Список_ящиков)
    :-
        входит_в(ящик(зелёный, есть), Список_ящиков)
    .
% 4. В жёлтом ящике приза нет.
    подсказка(4, Список_ящиков)
    :-
        входит_в(ящик(желтый,  нет), Список_ящиков)
    .
% Если подсказка истинна, то предикат возвращает 1, если ложна - то 0
    проверка_подсказки(Номер, Список_ящиков, Истинность) 
    :- 
        подсказка(Номер, Список_ящиков),
        Истинность = 1
    ;
...
% Проверка подсказок(три подсказки ошибочны и только одна правильная):
    ...
    :-
        проверка_подсказки(1, Список_ящиков, Истинность_1),
...
% подсчет количества призов
    ...
    :-
        подсчет_количества(Список_призов, есть, 1)
    .
