...
%% Высказывание 1. 
    ...
    знаем_что(1, Мужчина)
    :-
        входит_в(свойство(имеет_трех_сыновей,    да), Мужчина),
        входит_в(свойство(делает_зарядку,        да), Мужчина),
        входит_в(свойство(умеет_программировать, да), Мужчина)
    .
    знаем_что(1, Мужчина)
    :-
        входит_в(свойство(имеет_трех_сыновей, нет), Мужчина)
    ;
        входит_в(свойство(делает_зарядку, нет), Мужчина)
    .
...
%% Высказывание 2. 
    ...
    знаем_что(2, Мужчина)
    :-
        входит_в(свойство(носит_очки, нет), Мужчина)
    .
...
%% генерация гипотезы с проверкой
    ...
    :-
        ...
        Мужчина = 
        [
            свойство(имеет_трех_сыновей,    Статус_1), свойство(делает_зарядку, Статус_2),
    ...
    список_всех_гипотез(Список)
    :-
        findall(Гипотеза, генерация_гипотезы(Гипотеза), Список)
    .

%% отсеивание повторяющихся гипотез
    отсев_дублей([ Последний ], [ Последний ]).
    отсев_дублей([ Первый | Хвост_списка ], Итоговый_список)
    :-
        отсев_дублей(Хвост_списка, Итоговый_список_1),
    ...
    .
GOAL
    write("О_мужчине_который_носит_очки_можно_сказать:"),
    nl,
